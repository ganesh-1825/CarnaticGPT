...
def route_query(query: str) -> RouterResult:
    ...
    THEORY_CONCEPTS_LIST = [
        ...
        "shadava", "audava", "varja", "varja swara", "vakra", "vakra swara",
        "sampurna", "mandra sthayi", "tara sthayi", "hexatonic", "pentatonic"
    ]
    is_exam_theory = any(c in lower for c in THEORY_CONCEPTS_LIST) and any(t in lower for t in ["what is", "what are", "define", "explain", "short note", "write a note", "write a short note", "briefly explain", "differentiate", "compare", "list", "name", "how is", "vs", "difference", "structure", "how to", "how do", "performed", "how", "meaning of", "explain about", "define about"])
    ...
    if is_comp_info:
        ...
        intent = "RAGA_SCALE"
    elif any(t in lower for t in ["adi", "rupaka", "ata", "triputa", "eka", "chapu", "misra", "khanda"]) and any(w in lower for w in ["tala", "talam", "thala", "thalam"]):
        intent = "TALA_QUERY"

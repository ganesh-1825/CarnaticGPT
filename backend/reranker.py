...
class CarnaticReranker:
    ...
    def __init__(self):
        ...
        try:
            ...
            # Load a lightweight cross-encoder model for CPU reranking
            self.cross_encoder = CrossEncoder("cross-encoder/ms-marco-MiniLM-L-2-v2", device="cpu")
            logger.info("SentenceTransformers CrossEncoder loaded successfully on CPU.")
        ...
        if self.cross_encoder is not None:
            try:
                ...
                for i, score in enumerate(raw_scores):
                    # Sigmoid mapping to translate logit scores to a 0.0-1.0 scale
